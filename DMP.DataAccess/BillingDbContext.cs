...
public class BillingDbContext(DbContextOptions<BillingDbContext> options) : DbContext(options)
{
    ...
    public DbSet<CurrencySettingDAL> CurrencySettings { get; set; }
    public DbSet<GeneralLedgerDAL> GeneralLedgers { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CurrencySettingDAL>(entity =>
        {
            entity.ToTable("CurrencySetting");
            entity.HasKey(p => p.CurrencyId);

            entity.Property(e => e.CurrencyCode).HasColumnName("CurrencyCode").IsRequired().HasMaxLength(5);
            entity.Property(e => e.Name).HasColumnName("Name").IsRequired().HasMaxLength(150);
            entity.Property(e => e.Divisibility).HasColumnName("Divisibility");
            entity.Property(e => e.Crypto).HasColumnName("Crypto").IsRequired();
            entity.Property(e => e.Symbol).HasColumnName("Symbol").HasMaxLength(3);
        });
